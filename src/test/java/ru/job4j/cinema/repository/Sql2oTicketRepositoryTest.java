...
class Sql2oTicketRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var session = sql2oFilmSessionRepository.save(new FilmSession(film.getId(), hall.getId(), startTime, endTime, 10));
        var ticket = sql2oTicketRepository.save(new Ticket(session.getId(), 2, 3, 1));
        var savedTicket = sql2oTicketRepository.findTicket(ticket).get();
