...
class Sql2oUserRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        var user = sql2oUserRepository.save(new User("Roman", "test@mail.ru", "123456"));
    ...
    public void whenSaveSameEmailTwice() {
        var user1 = sql2oUserRepository.save(new User("Roman", "test@mail.ru", "123456"));
        var user2 = sql2oUserRepository.save(new User("Petr", "test@mail.ru", "654321"));
